...
void Mma8451q_Init(void)
{
	...
	//2g / 0.063g = 32 counts
	I2C_WriteReg(REG_WHO_AM_I, PULSE_THSX, 0x64); //Set X Threshold 
	I2C_WriteReg(REG_WHO_AM_I, PULSE_THSY, 0x64); //Set Y Threshold 
	I2C_WriteReg(REG_WHO_AM_I, PULSE_THSZ, 0x64); //Set Z Threshold 
